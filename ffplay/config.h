...
#define FFMPEG_CONFIGURATION "--cc=gcc --arch=x86 --target-os=mingw32 --disable-debug --disable-doc --enable-amd3dnow --enable-amd3dnowext --enable-mmx --enable-mmxext --enable-sse --enable-sse2 --enable-sse3 --enable-ssse3 --enable-sse4 --enable-sse42 --x86asmexe=yasm --enable-shared --prefix=/d/PROJECT/OpenSource/6.3.0/ffmpeg-3.4.2 --enable-gpl --enable-version3 --enable-nonfree --enable-pthreads --disable-w32threads --disable-sdl2 --enable-dxva2 --enable-libmfx --enable-nvenc --enable-cuda-sdk --enable-libbs2b --disable-bzlib --enable-libass --enable-libbs2b --enable-libcdio --enable-libfreetype --enable-libfribidi --enable-libvorbis --enable-libfdk-aac --enable-libkvazaar --enable-libgsm --enable-libilbc --enable-libmp3lame --enable-libopencore-amrnb --enable-libfontconfig --enable-libopencore-amrwb --enable-libx264 --enable-libflite --enable-libvo-amrwbenc --enable-libspeex --enable-libsoxr --enable-libvpx --enable-libxvid --enable-libx265 --enable-libwebp --enable-libwavpack --enable-libtheora --enable-libtwolame --enable-libshine --enable-libsnappy --enable-libxavs --enable-libopus --enable-libvidstab --extra-cflags='-fPIC -DKVZ_STATIC_LIB -DLIBTWOLAME_STATIC -I/d/PROJECT/OpenSource/6.3.0/include -I/d/PROJECT/OpenSource/6.3.0/inc -I/cuda/include' --extra-ldflags='-L/d/PROJECT/OpenSource/6.3.0/lib -L/d/PROJECT/OpenSource/6.3.0/x86/mingw/staticlib -L/cuda/lib/win32' --extra-libs='-fopenmp -lwinmm -ldvdnav -ldvdread -ldvdcss'"
#define FFMPEG_LICENSE "nonfree and unredistributable"
#define CONFIG_THIS_YEAR 2018
#define FFMPEG_DATADIR "/d/PROJECT/OpenSource/6.3.0/ffmpeg-3.4.2/share/ffmpeg"
#define AVCONV_DATADIR "/d/PROJECT/OpenSource/6.3.0/ffmpeg-3.4.2/share/ffmpeg"
#define CC_IDENT "gcc 6.3.0 (i686-posix-dwarf-rev2, Built by MinGW-W64 project)"
...
#define CONFIG_H264_AMF_D3D11VA_ENCODER 1
...
#define CONFIG_HEVC_AMF_D3D11VA_ENCODER 1
...
#define CONFIG_DVDNAV_PROTOCOL 1
